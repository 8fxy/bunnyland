...
const worldCupProfiles = {
  rabbit_1: {
    team: "巴西",
    reactionMood: "失落但还认真",
    latestResult: "巴西1比2不敌挪威，止步16强",
    upcoming: "世界杯旅程止步16强",
    pending: "法国2比0淘汰摩洛哥后，8强赛还剩西班牙对比利时、挪威对英格兰、阿根廷对瑞士",
    reaction: "她把黄绿色小旗折小一点夹进图鉴，先恭喜劳伦斯，再把巴西那一页留出一朵没涂色的小花。",
    liveReaction: "她把黄绿色小旗压在杯垫边，只记录已经发生的镜头。",
    dialogues: ["巴西停在这里啦。", "劳伦斯，恭喜。", "这朵花先不涂色。", "我还会继续看。", "法国又往前啦。"]
  },
  rabbit_2: {
    team: "美国",
    reactionMood: "嘴硬但低落",
    latestResult: "美国1比4不敌比利时，止步16强",
    upcoming: "世界杯旅程止步16强",
    pending: "比利时将在上海时间7月11日03:00对西班牙，乔治只负责嘴硬旁听",
    reaction: "他把蓝帽子压低一点，先说比分牌可能太亮，又很快承认比利时踢得更稳；路过小泽时只小声哼了一下。",
    liveReaction: "他把蓝帽子扶正，等哨声以后才把比分写进便签。",
    dialogues: ["一比四也要记。", "帽子没有歪。", "小泽你先别笑。", "比利时确实稳。", "三点那场再说。"]
  },
  rabbit_3: {
    team: "比利时",
    reactionMood: "克制地开心",
    latestResult: "比利时4比1战胜美国晋级8强",
    upcoming: "四分之一决赛将于上海时间7月11日03:00对阵西班牙",
    pending: "7月10日先准备生日菜单和夜间看球杯垫，不提前写比分",
    reaction: "他把4比1写在杯垫背面，没有当着乔治的面晃，只把咖啡机声音调小，又给乔治多留了一块薄荷甜点。",
    liveReaction: "他把咖啡机时间和投影时间对齐，杯垫先留空不写比分。",
    dialogues: ["四比一，先收好。", "乔治，甜点还在。", "杯垫翻面写。", "下一场西班牙。", "三点那场再开机。"]
  },
  rabbit_4: {
    team: "法国",
    reactionMood: "高兴但很稳",
    latestResult: "法国2比0战胜摩洛哥晋级半决赛",
    upcoming: "半决赛对手将在西班牙与比利时之间产生",
    pending: "7月10日白天先把清晨看球留下的蓝线和杯垫收好",
    reaction: "她把法国队小旗从发带盒旁取下来，给蓝线又补了一针；听到2比0时笑得很轻，只提醒大家别把小泽的生日菜单弄皱。",
    liveReaction: "她把法国队小旗别在发带盒旁，开球后只记真实画面，等终场再把蓝线缝完整。",
    dialogues: ["Allez les Bleus.", "二比零，很稳。", "先别吵醒小泽。", "蓝线缝完整。", "半决赛再看。"]
  },
  rabbit_5: {
    team: "荷兰",
    reactionMood: "安静释然",
    latestResult: "荷兰1比1战平摩洛哥后点球2比3出局",
    upcoming: "世界杯旅程止步32强",
    pending: "摩洛哥0比2不敌法国后，杰拉德把那页橙色边框旁边留给清晨光",
    reaction: "他把橙色边框停在最后一个没画完的角，又给摩洛哥那页添了一小块阴影；法国赢球时，他没有翻页，只把线条压轻。",
    liveReaction: "他先画一条橙色边框，等比赛结束后再决定明暗。",
    dialogues: ["点球输了。", "这一角先空着。", "橙色不擦掉。", "今天慢点翻页。", "摩洛哥也停下了。"]
  },
  rabbit_6: {
    team: "挪威",
    reactionMood: "很振奋但收着",
    latestResult: "挪威2比1战胜巴西晋级8强",
    upcoming: "四分之一决赛将于上海时间7月12日05:00对阵英格兰",
    pending: "法国已经晋级半决赛，挪威还要等到7月12日05:00开球",
    reaction: "他把挪威淘汰巴西写在战术纸顶端，庆祝前先看了看小悠米，再把早餐照常分给大家。",
    liveReaction: "他把战术纸分成两栏，开球后只记真实发生的推进。",
    dialogues: ["二比一，赢巴西。", "小悠米，抱歉呀。", "下一场英格兰。", "战术纸再加一栏。", "五点那场要早起。"]
  },
  rabbit_7: {
    team: "日本",
    reactionMood: "失落但服气",
    latestResult: "日本1比2不敌巴西止步32强",
    upcoming: "世界杯旅程止步32强",
    pending: "法国2比0摩洛哥后，Lino继续记录剩下8强赛的夜间光线",
    reaction: "他把终场前丢球的那张照片留在相机里，没有马上删；等小悠米庆祝完，才轻声说这场拍得很好。",
    liveReaction: "他把曝光调低一点，等画面出现再轻轻按快门。",
    dialogues: ["最后一下太快了。", "一比二，记住了。", "照片先不删。", "小悠米，恭喜呀。", "瑞士点球很稳。"]
  }
};
...
const locationActivities = {
  tree_house: [
    ...
    { status: "对今日钟", detail: "{name}把树屋小钟和当天纸条对了一遍，没有把明天凌晨的比赛写进今晚。" },
    { status: "折薄毯角", detail: "{name}把薄毯角折出一个小记号，留给晚归兔兔确认回家的方向。" },
    { status: "收清晨闹钟", detail: "{name}把清晨看球用的小闹钟收进抽屉，指针还停在很早的位置。" }
  ],
  carrot_square: [
  ...
  mushroom_cafe: [
    ...
    { status: "核对投影钟", detail: "{name}把投影钟调到上海时间，又把尚未开球的比分栏全部擦干净。" },
    { status: "收夜间小旗", detail: "{name}把各队小旗按明后天开球顺序排好，只把下一场要用的杯垫留在桌边。" },
    { status: "擦清晨屏幕", detail: "{name}把清晨看球后留下的投影屏擦干净，角落还贴着一小段蓝色纸胶带。" },
  ...
  observatory: [
    ...
    { status: "校星图边", detail: "{name}把星图边缘压平，确认今晚讨论的是星座，不是还没开踢的比分。" },
    { status: "记迟到星", detail: "{name}把一颗迟到的星标在角落，旁边留给明天凌晨的闹钟。" }
  ],
  shell_bay: [
...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得7月9日在彩虹湖绕开软泥、去植物园挑枯叶，最后把新花补进树叶图鉴。",
    "记得自己支持巴西；法国2比0淘汰摩洛哥后，自己仍会把剩下8强赛程贴进图鉴边角。",
  ...
  rabbit_2: [
    ...
    "记得7月9日在植物园、音乐厅和咖啡馆之间把半张日期标签当成限量表盒，还把解释留到睡前前说清。",
    "记得自己支持美国；比利时将在7月11日03:00对西班牙，嘴硬可以有，但不能提前写比分。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_3: [
    ...
    "记得7月9日在图书馆、彩虹湖、咖啡馆和灯塔之间把贝壳、咖啡章和账单角排成新情报顺序。",
    "记得自己支持比利时；4比1战胜美国晋级8强后，7月11日03:00才是对西班牙的真实开球时间。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_4: [
    ...
    "记得7月9日在音乐厅、气象站和天文台之间整理发带色卡，还把明天凌晨的闹钟写在星图角落。",
    "记得自己支持法国；2比0战胜摩洛哥晋级半决赛后，要把蓝线缝完整，也别吵醒生日倒数的小泽。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_5: [
    ...
    "记得7月9日在音乐厅、咖啡馆、植物园和迷宫之间把日期标签、植物牌和面包屑星座接成第二章。",
    "记得自己支持荷兰；摩洛哥0比2不敌法国后，橙色边框旁边可以留一块安静的清晨阴影。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_6: [
    ...
    "记得7月9日在农场、齿轮工坊、植物园和咖啡馆之间把慢钟、薄荷田、餐盒和误会重新分栏。",
    "记得自己支持挪威；2比1战胜巴西晋级8强后，下一场是上海时间7月12日05:00对英格兰。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_7: [
    ...
    "记得7月9日拍过广场公告、彩虹湖赏荷便签、音乐厅调镜头和咖啡馆吃瓜照片。",
    "记得自己支持日本；1比2被巴西终场前绝杀后止步32强，法国2比0摩洛哥这天也会安静记录夜间光线。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ]
};
...
const relationships = limitRelationshipYaml(`relationships:
  rabbit_1:
    ...
    rabbit_5:
      ...
      - 6月29日小悠米把冰柜太阳印夹进图鉴后，杰拉德把同一枚印记画成冒险主角捡到的宝物。
    rabbit_6:
    ...
    rabbit_7:
      ...
      - 7月9日Lino在彩虹湖留下赏荷便签时，也会替小悠米把荷花倒影和图鉴路线拍清楚。
  rabbit_2:
    rabbit_6:
      - 乔治喊“给我劳”会让劳伦斯误以为在叫他。
      ...
      - 7月3日乔治再次喊出“给我劳”时马上补完手表解释，劳伦斯虽然表情复杂，还是先听到了最后。
    rabbit_3:
      - 乔治给小泽咖啡馆友情提供植物园薄荷。
      - 小泽常把乔治吃瘪的表情做成咖啡奶泡。
      ...
      - 7月10日比利时赛前，小泽会把3点开球写在杯垫边角，乔治只能旁听不能提前嘴硬成赛果。
    rabbit_4:
      - 乔治喜欢晓雪，也只有晓雪能治住他。
      - 晓雪会用法语和浓缩咖啡让乔治慢慢解释。
      - 晓雪递咖啡时，乔治会短暂收起调皮劲。
  ...
  rabbit_3:
    ...
    rabbit_7:
      ...
      - 7月9日小泽整理生日菜单和情报顺序时，Lino会拍下咖啡章、账单角和没写比分的杯垫。
    rabbit_4:
      - 小泽推出新品时总邀请晓雪拍照推广。
      - 小泽会给晓雪预留新品照片位和温柔灯光。
  ...
  rabbit_5:
    ...
    rabbit_6:
      ...
      - 7月8日杰拉德在咖啡馆躲开加餐时，劳伦斯会先扣好餐盒，不立刻端过去。
      - 摩洛哥0比2输给法国后，劳伦斯会让杰拉德把橙色边框和清晨阴影慢慢画完，再问要不要加餐。
    rabbit_3:
      - 杰拉德给小泽咖啡馆设计了招牌。
  ...
  rabbit_6:
    ...
    rabbit_3:
      ...
      - 挪威下一场还没到开球时间时，小泽会帮劳伦斯把战术纸和早餐订单分开放。
      - 7月10日法国先晋级后，小泽会提醒劳伦斯别把挪威对英格兰的早餐闹钟设错日期。
  rabbit_7:
    rabbit_1:
    ...
    rabbit_2:
      ...
      - 7月9日Lino在音乐厅拍到乔治解释现场时，会故意把快门声放轻，避免误会越拍越大。
