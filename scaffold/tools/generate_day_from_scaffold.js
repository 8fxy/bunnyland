...
const worldCupProfiles = {
  ...
  rabbit_5: {
    ...
    latestResult: "世界杯已经结束，西班牙夺冠",
    upcoming: "没有待观看的比赛",
    pending: "橙色边框已经画完，接下来把看球角改画成初夏咖啡馆",
...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得7月25日在图书馆找稀有花、去彩虹湖捡亮贝壳，也把咖啡馆旧小旗和鲜花图鉴分别收好。",
  ...
  rabbit_2: [
    ...
    "记得7月25日在植物园、工坊和咖啡馆之间照看薄荷、擦齿轮，也发现旧比分纸翻面可以当书签。",
  ...
  rabbit_3: [
    ...
    "记得7月25日在广场、音乐厅、咖啡馆和彩虹湖之间收消息，让旧直播桌退场后重新邀请晓雪拍甜点。",
  ...
  rabbit_4: [
    ...
    "记得7月25日在气象站、天文台、兔耳山和咖啡馆之间整理发带、镜片、溪水声与赛后杯垫。",
  ...
  rabbit_5: [
    ...
    "记得7月25日被日期种子选中清晨去植物园，补觉后在迷宫、彩虹湖和咖啡馆继续画日常与荷花。",
    "记得自己支持荷兰；世界杯结束后补完橙色边框，下一页改画卷起投影布的初夏咖啡馆。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_6: [
    ...
    "记得7月25日在咖啡馆、广场、农场和工坊之间照看大家、打包甜点并检查慢钟的小螺丝。",
  ...
  rabbit_7: [
    ...
    "记得7月25日在彩虹湖绕软泥、去咖啡馆擦赛后屏幕，也拍下晓雪发带和乔治解释现场。",
...
const relationships = limitRelationshipYaml(`relationships:
  rabbit_1:
    ...
    rabbit_5:
      ...
      - 7月25日小悠米把亮贝壳和稀有花收进图鉴，杰拉德则把荷花、迷宫转角和赛后咖啡馆接成新的日常章节。
    rabbit_6:
    ...
    rabbit_7:
      ...
      - 7月25日Lino绕开彩虹湖软泥并记录植物园花样本时，也替小悠米留住荷花倒影和图鉴路线。
  rabbit_2:
    rabbit_6:
      - 乔治喊“给我劳”会让劳伦斯误以为在叫他。
      ...
      - 7月25日乔治在工坊擦齿轮后把解释说完整，劳伦斯也先听完再检查慢钟和小螺丝。
    rabbit_3:
      - 乔治给小泽咖啡馆友情提供植物园薄荷。
      - 小泽常把乔治吃瘪的表情做成咖啡奶泡。
  ...
  rabbit_3:
    ...
    rabbit_7:
      ...
      - 7月25日小泽让咖啡馆恢复甜点和闲聊时，Lino拍下洗净杯垫、赛后屏幕与重新亮起的吧台灯。
    rabbit_4:
      - 小泽推出新品时总邀请晓雪拍照推广。
      - 小泽会给晓雪预留新品照片位和温柔灯光。
  ...
  rabbit_4:
    rabbit_7:
      ...
      - 7月25日晓雪在气象站和天文台整理发带与镜片时，Lino把赛后恢复安静的咖啡馆光线也留给她。
    rabbit_6:
  ...
  rabbit_5:
    ...
    rabbit_6:
      ...
      - 7月25日杰拉德清晨短巡后继续画荷花和咖啡馆，劳伦斯先把甜点包稳，再问他要不要加餐。
  ...
  rabbit_7:
    ...
    rabbit_2:
      ...
      - 7月25日Lino在广场拍到乔治解释现场时仍把快门声放轻，让劳伦斯有时间听清后半句。
