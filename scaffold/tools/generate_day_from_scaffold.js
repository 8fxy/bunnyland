...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得7月10日在咖啡馆擦糖罐、去海湾翻小贝壳，又把广场遮阳牌和灯塔小册整理好。",
  ...
  rabbit_2: [
    ...
    "记得7月10日在兔耳山、图书馆、植物园和咖啡馆之间照看薄荷，还把广场遮阳牌扶正。",
  ...
  rabbit_3: [
    ...
    "记得7月10日在灯塔、广场、植物园和音乐厅之间收集消息，最后把糖罐和生日菜单整理妥当。",
  ...
  rabbit_4: [
    ...
    "记得7月10日在气象站、天文台、咖啡馆和兔耳山之间整理云层、发带与衣帽间。",
  ...
  rabbit_5: [
    ...
    "记得7月10日在海湾、音乐厅、咖啡馆、植物园和迷宫之间收杯垫、认新叶子并数清转角。",
  ...
  rabbit_6: [
    ...
    "记得7月10日在音乐厅、广场、咖啡馆、农场和工坊之间收谱架夹、写生日菜单并检查齿轮。",
  ...
  rabbit_7: [
    ...
    "记得7月10日在广场、彩虹湖、音乐厅、咖啡馆、兔耳山和灯塔拍下解释、倒影、生日菜单与发带街拍。",
