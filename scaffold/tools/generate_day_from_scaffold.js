...
const worldCupProfiles = {
  ...
  rabbit_2: {
    ...
    upcoming: "世界杯旅程止步16强",
    pending: "8强赛从上海时间7月10日04:00开始",
    reaction: "他把蓝帽子压低一点，先说比分牌可能太亮，又很快承认比利时踢得更稳；路过小泽时只小声哼了一下。",
    liveReaction: "他把蓝帽子扶正，等哨声以后才把比分写进便签。",
    dialogues: ["一比四也要记。", "帽子没有歪。", "小泽你先别笑。", "比利时确实稳。", "今晚先不直播。"]
  },
  rabbit_3: {
    team: "比利时",
    reactionMood: "克制地开心",
    latestResult: "比利时4比1战胜美国晋级8强",
    upcoming: "四分之一决赛将于上海时间7月11日06:00对阵西班牙",
    pending: "7月9日先整理杯垫和小旗，不提前写比分",
    reaction: "他把4比1写在杯垫背面，没有当着乔治的面晃，只把咖啡机声音调小，又给乔治多留了一块薄荷甜点。",
    liveReaction: "他把咖啡机时间和投影时间对齐，杯垫先留空不写比分。",
    dialogues: ["四比一，先收好。", "乔治，甜点还在。", "杯垫翻面写。", "下一场西班牙。", "六点那场再开机。"]
  },
  rabbit_4: {
    team: "法国",
    reactionMood: "松一口气",
    latestResult: "法国1比0战胜巴拉圭晋级8强",
    upcoming: "四分之一决赛将于上海时间7月10日04:00对阵摩洛哥",
    pending: "7月9日晚上要早点把发带和闹钟都放好",
    reaction: "她给发带补上一针很细的蓝线，听到只赢一球时反而把色卡收得更稳，提醒大家别把庆祝声放得太满。",
    liveReaction: "她把法国队小旗别在发带盒旁，比分栏先空着。",
    dialogues: ["Allez les Bleus.", "一比零也要稳。", "下一场摩洛哥。", "蓝线缝细一点。", "闹钟放发带旁。"]
  },
  rabbit_5: {
    team: "荷兰",
    reactionMood: "闷闷的",
    ...
    upcoming: "世界杯旅程止步32强",
    pending: "摩洛哥将于上海时间7月10日04:00对阵法国",
    reaction: "他把橙色边框停在最后一个没画完的角，点球数字写得很小，今天不急着把这页翻过去。",
    liveReaction: "他先画一条橙色边框，等比赛结束后再决定明暗。",
    dialogues: ["点球输了。", "这一角先空着。", "橙色不擦掉。", "今天慢点翻页。", "摩洛哥还在往前。"]
  },
  rabbit_6: {
    team: "挪威",
    reactionMood: "很振奋但收着",
...
const worldCupMatchesByShanghaiDate = {
  ...
  "2026-07-11": [
    { kickoff: "06:00", kickoffTick: 2160, home: "西班牙", away: "比利时" }
  ],
  "2026-07-12": [
...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得7月8日在贝壳海湾、胡萝卜广场和咖啡馆之间收集纸条、贝壳光和节目单线索。",
    "记得自己支持巴西；1比2输给挪威止步16强后，仍会跟着8强赛程继续看。",
  ...
  rabbit_2: [
    ...
    "记得7月8日在广场数过小萝卜箭头，也在齿轮工坊和植物园之间继续解释手表梗。",
    "记得自己支持美国；1比4输给比利时止步16强，7月9日先承认赛程表比嘴硬更重要。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_3: [
    ...
    "记得自己的生日进入3天倒数时，咖啡馆情报等级会悄悄升一格。",
    "记得灯塔门铃声滚到海湾时，要把杯垫翻面那行小字收进情报站。",
    "记得胡萝卜广场的小萝卜箭头也能和杯垫小字接上，不只咖啡馆有情报。",
    "记得糖罐底下折过三次的小票值得收进账本，别让奶泡盖住。",
    "记得7月8日在灯塔小册、广场纸条和咖啡馆账本之间整理出新的情报顺序。",
    "记得自己支持比利时；4比1战胜美国晋级8强后，7月11日06:00才是对西班牙的真实开球时间。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_4: [
    ...
    "记得7月8日整理过图书馆索引页、音乐厅节目单和气象站读数，发带尾巴要按回原位。",
    "记得自己支持法国；1比0战胜巴拉圭晋级8强后，下一场是上海时间7月10日04:00对摩洛哥。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_5: [
    ...
    "记得7月8日在海湾、音乐厅和咖啡馆之间把贝壳光、节目单和糖罐倒影接成第二章。",
    "记得自己支持荷兰；摩洛哥淘汰荷兰后还会在7月10日04:00对法国，橙色边框可以先留着。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_6: [
    ...
    "记得7月8日在齿轮工坊、植物园和咖啡馆之间把慢钟、餐盒与误会重新分栏。",
  ...
  rabbit_7: [
    ...
    "记得7月8日拍过兔耳山解释现场、灯塔灯罩和植物园枯叶，光线从路牌旁边斜过来。",
    "记得自己支持日本；1比2被巴西终场前绝杀后止步32强，看到瑞士点球晋级也会安静记录。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ]
};
...
const relationships = limitRelationshipYaml(`relationships:
  rabbit_1:
    ...
    rabbit_7:
      ...
      - 7月8日小悠米在海湾和广场收集纸条时，Lino会把她没看见的路牌角度补拍下来。
  rabbit_2:
    rabbit_6:
      - 乔治喊“给我劳”会让劳伦斯误以为在叫他。
    ...
    rabbit_3:
      ...
      - 7月9日没有上海时间比赛直播时，小泽会提醒乔治先别把嘴硬写成新比分。
    rabbit_4:
      - 乔治喜欢晓雪，也只有晓雪能治住他。
      - 晓雪会用法语和浓缩咖啡让乔治慢慢解释。
      - 晓雪递咖啡时，乔治会短暂收起调皮劲。
