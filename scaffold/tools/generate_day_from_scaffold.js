...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得7月27日在植物园、海湾、灯塔和咖啡馆之间收花样、量潮线，还把旧赛程翻面改成日常菜单。",
  ...
  rabbit_2: [
    ...
    "记得7月27日在植物园、工坊、兔耳山和咖啡馆之间养薄荷、找螺丝，也重新系紧营地细绳。",
  ...
  rabbit_3: [
    ...
    "记得7月27日被日期种子选中清晨去图书馆，补觉后把杯垫、旧地图、荷花便签和新品消息排成一页。",
  ...
  rabbit_4: [
    ...
    "记得7月27日在图书馆、气象站、天文台、兔耳山和咖啡馆之间整理书页灰、发带与盛夏光线。",
  ...
  rabbit_5: [
    ...
    "记得7月27日在海湾、音乐厅、迷宫和彩虹湖之间收潮声、节目单与落水路线纸，再画进咖啡馆招牌。",
  ...
  rabbit_6: [
    ...
    "记得7月27日在农场、工坊、灯塔和海湾之间收萝卜、试门铃、翻贝壳，最后把甜点稳稳打包。",
  ...
  rabbit_7: [
    ...
    "记得7月27日在植物园、彩虹湖、音乐厅和兔耳山之间拍花样、荷叶水珠与风向带，也记录乔治解释现场。",
...
const relationships = limitRelationshipYaml(`relationships:
  rabbit_1:
    ...
    rabbit_5:
      ...
      - 7月27日小悠米把花样、潮线和旧赛程画进图鉴，杰拉德则把落水路线纸、迷宫转角和海湾沙线接成新章节。
    rabbit_6:
    ...
    rabbit_7:
      ...
      - 7月27日Lino拍下彩虹湖荷叶水珠和植物园花样时，也替小悠米留住试飞路线与盛夏倒影。
  rabbit_2:
    rabbit_6:
      - 乔治喊“给我劳”会让劳伦斯误以为在叫他。
      ...
      - 7月27日乔治在工坊找小螺丝、去山上系营绳时把话说完整，劳伦斯也先听完再试门铃。
    rabbit_3:
      - 乔治给小泽咖啡馆友情提供植物园薄荷。
      - 小泽常把乔治吃瘪的表情做成咖啡奶泡。
  ...
  rabbit_3:
    ...
    rabbit_7:
      ...
      - 7月27日小泽清晨去图书馆后把旧地图和新品消息排好，Lino拍下杯垫、荷叶水珠与吧台恢复日常的光。
    rabbit_4:
      - 小泽推出新品时总邀请晓雪拍照推广。
      - 小泽会给晓雪预留新品照片位和温柔灯光。
  ...
  rabbit_4:
    rabbit_7:
      ...
      - 7月27日晓雪记录雨量杯、晨星和山路云时，Lino也把风向带与她的盛夏发带收进同一组照片。
    rabbit_6:
  ...
  rabbit_5:
    ...
    rabbit_6:
      ...
      - 7月27日杰拉德在海湾量潮线、去咖啡馆躲加餐时，劳伦斯先把甜点包稳，等他画完再问。
  ...
  rabbit_7:
    ...
    rabbit_2:
      ...
      - 7月27日Lino记录乔治解释现场和兔耳山风向带时仍把快门声放轻，让劳伦斯先听清再判断。
