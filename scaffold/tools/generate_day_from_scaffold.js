...
const worldCupProfiles = {
  rabbit_1: {
    ...
    upcoming: "上海时间6月30日01:00在32强对阵日本",
  ...
  rabbit_2: {
    ...
    upcoming: "上海时间7月2日08:00在32强对阵波黑",
  ...
  rabbit_3: {
    team: "比利时",
    reactionMood: "松快",
    latestResult: "比利时5比1战胜新西兰并以小组第一晋级",
    upcoming: "上海时间7月2日04:00在32强对阵塞内加尔",
    reaction: "他在杯垫上只写了一个小小的5比1，转身却给每杯咖啡都多撒了一点巧克力粉。",
    liveReaction: "他把咖啡机时间和投影时间对齐，杯垫先留空不写比分。",
    dialogues: ["五比一呀。", "巧克力粉多一点。", "小组第一。", "杯垫先留着。"]
  },
  rabbit_4: {
    team: "法国",
    reactionMood: "雀跃",
    latestResult: "法国4比1战胜挪威并以小组第一晋级",
    upcoming: "上海时间7月1日05:00在32强对阵瑞典",
    reaction: "她把四个进球缝成发带边上四个很小的蓝点，庆祝时也记得把劳伦斯的那杯咖啡推近一点。",
    liveReaction: "她把法国队小旗别在发带盒旁，比分栏先空着。",
    dialogues: ["Allez les Bleus.", "四比一啦。", "劳伦斯，咖啡给你。", "蓝点缝四个。"]
  },
  rabbit_5: {
    team: "荷兰",
    reactionMood: "振奋",
    latestResult: "荷兰3比1战胜突尼斯并以小组第一晋级",
    upcoming: "上海时间6月30日09:00在32强对阵摩洛哥",
  ...
  rabbit_6: {
    team: "挪威",
    reactionMood: "低落但踏实",
    latestResult: "挪威1比4不敌法国但仍以小组第二晋级",
    upcoming: "上海时间7月1日01:00在32强对阵科特迪瓦",
    reaction: "他把1比4端端正正写完，没有撕掉战术纸；确认挪威仍然晋级后，才把剩下的早餐分给大家。",
    liveReaction: "他把战术纸分成两栏，开球后只记真实发生的推进。",
    dialogues: ["一比四也要写。", "还是晋级了。", "战术纸不撕。", "早餐还有。"]
  },
  rabbit_7: {
    team: "日本",
    reactionMood: "安定",
    latestResult: "日本1比1战平瑞典并以小组第二晋级",
    upcoming: "上海时间6月30日01:00在32强对阵巴西",
...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得6月29日把冰柜太阳印夹进图鉴当探险徽章，后来还在灯塔灯罩里照见旧地图角。",
  ...
  rabbit_2: [
    ...
    "记得6月29日给小泽摘过薄荷，也在七号桌点心旁练习把手表解释完整。",
  ...
  rabbit_3: [
    ...
    "记得6月29日扶正灯塔小台阶、数过被转半圈的小萝卜，睡前又想起借阅卡背面的铅笔字。",
    "记得自己支持比利时；5比1战胜新西兰并以小组第一晋级后，嘴上只淡淡说一句，巧克力粉却会多撒一点。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_4: [
    ...
    "记得6月29日绑好植物牌、擦清山路旧箭头，还在节目单角落盖了一枚咖啡章。",
    "记得自己支持法国；4比1战胜挪威并以小组第一晋级后，会庆祝，也会照顾支持挪威而失落的劳伦斯。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_5: [
    ...
    "记得6月29日把冰柜太阳印画成冒险道具，灯塔门铃声和借阅卡铅笔字可以接成下一页。",
  ...
  rabbit_6: [
    ...
    "记得6月29日读过空白比分表公告、检查田埂脚印，也把映出旧地图线的齿轮擦亮。",
    "记得自己支持挪威；1比4输给法国时会低落，但确认挪威仍以小组第二晋级后，会把比分写完整再继续照顾大家。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_7: [
    ...
    "记得6月29日替晓雪拍了薄荷色发带街拍，还在灯塔小册第一页发现冰柜太阳印。",
...
const relationships = limitRelationshipYaml(`relationships:
  ...
  rabbit_3:
    ...
    rabbit_7:
      ...
      - 比利时5比1战胜新西兰并以小组第一晋级后，Lino会拍下小泽嘴上平静、手上却多撒巧克力粉的样子。
    rabbit_4:
      - 小泽推出新品时总邀请晓雪拍照推广。
      - 小泽会给晓雪预留新品照片位和温柔灯光。
