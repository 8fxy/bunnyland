...
const worldCupProfiles = {
  rabbit_1: {
    team: "巴西",
    reactionMood: "又惊又喜",
    latestResult: "巴西2比1战胜日本晋级16强",
    upcoming: "上海时间7月6日04:00在16强对阵挪威",
    reaction: "她看到终场前的进球差点碰翻蜂蜜罐，庆祝完又把声音压低，给身边支持日本的Lino留一点安静。",
    liveReaction: "她把黄绿色小旗压在杯垫边，只记录已经发生的镜头。",
    dialogues: ["最后才进呀。", "二比一，吓一跳。", "Lino，你还好吗。", "下一场挪威。"]
  },
  rabbit_2: {
    team: "美国",
    reactionMood: "得意",
    latestResult: "美国2比0战胜波黑晋级16强",
    upcoming: "上海时间7月7日08:00在16强对阵比利时",
    reaction: "他把2比0写在蓝帽子便签最中间，走过吧台时故意咳了一声，等小泽先提起下一场。",
    liveReaction: "他把蓝帽子扶正，等哨声以后才把比分写进便签。",
    dialogues: ["二比零，看到没。", "帽子一直很正。", "下一场是比利时。", "小泽，先说好啊。"]
  },
  rabbit_3: {
    team: "比利时",
    reactionMood: "后怕又兴奋",
    latestResult: "比利时加时3比2逆转塞内加尔晋级16强",
    upcoming: "上海时间7月7日08:00在16强对阵美国",
    reaction: "他把两球落后到加时逆转分成三张杯垫，最后一张手有点抖；看见乔治的蓝帽子时先把咖啡机声音调小。",
    liveReaction: "他把咖啡机时间和投影时间对齐，杯垫先留空不写比分。",
    dialogues: ["两球都追回来啦。", "加时才赢。", "手还有点抖。", "乔治，下一场见。"]
  },
  rabbit_4: {
    team: "法国",
    reactionMood: "明亮",
    latestResult: "法国3比0战胜瑞典晋级16强",
    upcoming: "上海时间7月5日05:00在16强对阵巴拉圭",
    reaction: "她给发带添了三针蓝线，没有把胜利说得太满，只把巴拉圭写到色卡背面。",
    liveReaction: "她把法国队小旗别在发带盒旁，比分栏先空着。",
    dialogues: ["Allez les Bleus.", "三比零，很稳。", "巴拉圭写背面。", "蓝线缝三针。"]
  },
  rabbit_5: {
    team: "荷兰",
    reactionMood: "闷闷的",
  ...
  rabbit_6: {
    team: "挪威",
    reactionMood: "振奋",
    latestResult: "挪威2比1战胜科特迪瓦晋级16强",
    upcoming: "上海时间7月6日04:00在16强对阵巴西",
    reaction: "他把挪威第一次淘汰赛胜利写在战术纸顶端，又给巴西单独留了一整栏；早餐还是照常分给大家。",
    liveReaction: "他把战术纸分成两栏，开球后只记真实发生的推进。",
    dialogues: ["第一次赢淘汰赛。", "二比一，写好了。", "下一场巴西。", "战术纸再加一栏。"]
  },
  rabbit_7: {
    team: "日本",
    reactionMood: "失落但服气",
...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得7月3日在咖啡馆试过新点心、抖出一口袋海湾细沙，还沿广场路牌重新确认路线。",
    "记得自己支持巴西；2比1淘汰日本后要照顾Lino的失落，16强会遇到劳伦斯支持的挪威。",
  ...
  rabbit_2: [
    ...
    "记得7月3日在植物园认出蓝帽子角度的薄荷叶，再次喊出‘给我劳’后要马上把手表解释说完。",
    "记得自己支持美国；2比0淘汰波黑并迎来24年来首场淘汰赛胜利，16强将和小泽支持的比利时交手。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_3: [
    ...
    "记得7月3日请晓雪拍照、在咖啡馆试点心，也从借阅卡背面的铅笔字找到迷宫方向。",
    "记得自己支持比利时；从两球落后追到加时3比2淘汰塞内加尔后仍会手抖，16强要面对乔治支持的美国。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_4: [
    ...
    "记得7月3日绑好植物牌、盖过节目单咖啡章，还从索引页找到三颗毛豆旁的编号。",
    "记得自己支持法国；3比0淘汰瑞典后只在发带缝三针蓝线，16强对巴拉圭也不要太早下结论。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_5: [
    ...
    "记得7月3日摆好音乐厅节目单、试过咖啡馆点心，也替松开的植物牌重新打结。",
  ...
  rabbit_6: [
    ...
    "记得7月3日收好贝壳光、摆齐音乐厅节目单，穿厚毛衣吃煎饼果子时仍惦记杰拉德要不要加餐。",
    "记得自己支持挪威；2比1淘汰科特迪瓦取得队史首场世界杯淘汰赛胜利，16强要面对小悠米支持的巴西。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_7: [
    ...
    "记得7月3日整理露营绳、拍下乔治向劳伦斯解释的现场，也在植物园认出蓝帽子角度的薄荷叶。",
...
const relationships = limitRelationshipYaml(`relationships:
  ...
  rabbit_2:
    ...
    rabbit_3:
      ...
      - 美国和比利时将在16强交手，乔治与小泽约好共用投影桌，开球前不拿旧比分互相逗。
    rabbit_4:
      - 乔治喜欢晓雪，也只有晓雪能治住他。
      - 晓雪会用法语和浓缩咖啡让乔治慢慢解释。
      - 晓雪递咖啡时，乔治会短暂收起调皮劲。
