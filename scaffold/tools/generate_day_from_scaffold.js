...
const bodilyBeats = [
  ...
  "他先笑了一声，发现没人问，又自己把话接了下去",
  "她咬住吸管想了一会儿，只说了最要紧的四个字",
  "两只爪子同时去拿杯垫，又同时缩了回来",
  "他揉了揉刚睡醒的耳根，决定先不装作听懂",
  "她本来已经走过门口，又倒回来把纸条压好"
];
...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得6月28日在彩虹湖看过初夏荷花，还把溪水小石头夹进图鉴当作探险徽章。",
  ...
  rabbit_2: [
    ...
    "记得6月28日在工坊重新校准慢了两拍的钟，空白比分表没有比赛就不要乱填。",
  ...
  rabbit_3: [
    ...
    "记得6月28日借阅卡背面的铅笔字指向迷宫，露营绳结上还夹着一片干薄荷叶。",
  ...
  rabbit_4: [
    ...
    "记得6月28日收好溪水小石头做穿搭灵感，也确认没有比赛时咖啡馆投影布不会放下。",
  ...
  rabbit_5: [
    ...
    "记得6月28日樱桃纸袋底下洇出的两个浅红圆点，可以画进不需要旁白的一页。",
  ...
  rabbit_6: [
    ...
    "记得6月28日在灯塔试门铃时看到蓝白格布角沾着松针，回家前还要确认大家到齐。",
  ...
  rabbit_7: [
    ...
    "记得6月28日拍下乔治向劳伦斯解释的现场，还把溪水小石头放在镜头旁当色彩参考。",
