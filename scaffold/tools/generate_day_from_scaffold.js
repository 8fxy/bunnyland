...
const locationActivities = {
  ...
  acorn_library: [
    ...
    { status: "给旧书透气", detail: "{name}把几本旧书在窗边错开半寸，让盛夏的风从书页之间慢慢穿过去。" }
  ],
  botanical_garden: [
...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得7月30日在广场、灯塔、图书馆和海湾之间接起图鉴路线，也把花样本与沙线分别收好。",
  ...
  rabbit_2: [
    ...
    "记得7月30日在植物园、工坊、咖啡馆和兔耳山之间养薄荷、擦齿轮，也把手表解释说到最后。",
  ...
  rabbit_3: [
    ...
    "记得7月30日在咖啡馆、图书馆、彩虹湖和灯塔之间改菜单、看荷花、坐凉石阶并整理新品情报。",
  ...
  rabbit_4: [
    ...
    "记得7月30日在音乐厅、气象站、天文台、兔耳山和咖啡馆之间整理折扇印、发带与盛夏光线。",
  ...
  rabbit_5: [
    ...
    "记得7月30日在海湾、音乐厅、迷宫、彩虹湖和灯塔之间收潮声、折扇印、出口箭头与小册线索。",
  ...
  rabbit_6: [
    ...
    "记得7月30日在咖啡馆、农场、灯塔和海湾之间晾杯垫、打包甜点、坐凉石阶并收贝壳光。",
  ...
  rabbit_7: [
    ...
    "记得7月30日被日期种子选中清晨去音乐厅，补觉后拍遮阳伞、发带、晨星和微雨后的云层。",
...
const relationships = limitRelationshipYaml(`relationships:
  rabbit_1:
    ...
    rabbit_5:
      ...
      - 7月30日小悠米把植物牌、旧地图和海湾沙线画进图鉴，杰拉德则把折扇印、迷宫出口和灯塔小册接成新章节。
    rabbit_6:
    ...
    rabbit_7:
      ...
      - 7月30日Lino拍下彩虹湖遮阳伞和植物园花样时，也替小悠米留住微雨后的试飞路线。
  rabbit_2:
    rabbit_6:
      - 乔治喊“给我劳”会让劳伦斯误以为在叫他。
      ...
      - 7月30日乔治在工坊擦齿轮、去山路听溪水时把解释说完整，劳伦斯也先听完再确认手表梗。
    rabbit_3:
      - 乔治给小泽咖啡馆友情提供植物园薄荷。
      - 小泽常把乔治吃瘪的表情做成咖啡奶泡。
  ...
  rabbit_3:
    ...
    rabbit_7:
      ...
      - 7月30日小泽把旧赛程改成盛夏菜单并邀请晓雪拍新品，Lino则拍下杯垫、遮阳伞和吧台灯。
    rabbit_4:
      - 小泽推出新品时总邀请晓雪拍照推广。
      - 小泽会给晓雪预留新品照片位和温柔灯光。
  ...
  rabbit_4:
    rabbit_7:
      ...
      - 7月30日晓雪整理折扇印、迟到星和山路溪石时，Lino也把她的盛夏发带与微雨光线收进照片。
    rabbit_6:
  ...
  rabbit_5:
    ...
    rabbit_6:
      ...
      - 7月30日杰拉德在咖啡馆保持忧郁、去海湾抖沙线时，劳伦斯先把甜点和杯垫收稳，等他画完再问。
  ...
  rabbit_7:
    ...
    rabbit_2:
      ...
      - 7月30日Lino清晨短巡后仍会轻声记录乔治解释现场，让劳伦斯先听清手表梗再判断。
