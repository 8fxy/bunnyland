...
const bodilyBeats = [
  ...
  "爪尖本来已经伸出去，想了想又先问了一句",
  "笑声压在杯子后面，只露出一点耳尖",
  "话到嘴边换了个更短的说法，听起来反而像真的",
  "脚尖蹭过石板上的水痕，停在没有太阳的那格",
  "先笑了一声，发现没人问，又自己把话接了下去",
  "咬住吸管想了一会儿，只说了最要紧的四个字",
  "两只爪子同时去拿杯垫，又同时缩了回来",
  "刚睡醒的耳根被揉了揉，决定先不装作听懂",
  "脚步本来已经走过门口，又倒回来把纸条压好",
  "手里的东西换到另一边，空出爪子比了个很小的圈",
  "想反驳的话刚冒头，又被一口凉水压了回去",
  "眼神追着滚远的葡萄走了两步，原来的话题暂时断掉"
];
...
const worldCupProfiles = {
  rabbit_1: {
    team: "巴西",
    reactionMood: "已经放下输赢",
    latestResult: "世界杯已经结束，西班牙夺冠",
    upcoming: "没有待观看的比赛",
    pending: "把巴西小旗夹回鲜花图鉴，空出来的晚上继续赏荷和找新花",
    reaction: "她把黄绿色小旗折成书签，冠军页旁边画了一朵小花，没再追着比分跑。",
    liveReaction: "",
    dialogues: ["小旗变书签啦。", "冠军页画朵花。", "今晚不设闹钟。", "去湖边找新花。", "比分表收起来啦。"]
  },
  rabbit_2: {
    team: "美国",
    reactionMood: "恢复调皮",
    latestResult: "世界杯已经结束，西班牙夺冠",
    upcoming: "没有待观看的比赛",
    pending: "把美国队贴纸贴进旧表盒，凌晨闹钟改回正常起床提醒",
    reaction: "他把蓝帽子扶正，承认冠军踢得稳，转头又开始研究旧表盒能不能装薄荷。",
    liveReaction: "",
    dialogues: ["闹钟终于能关啦。", "冠军确实踢得稳。", "贴纸放表盒里。", "小泽别翻旧比分。", "蓝帽子没压扁。"]
  },
  rabbit_3: {
    team: "比利时",
    reactionMood: "轻松收尾",
    latestResult: "世界杯已经结束，西班牙夺冠",
    upcoming: "没有待观看的比赛",
    pending: "拆掉直播桌，把比利时杯垫归档，咖啡馆晚上恢复甜点和闲聊",
    reaction: "他把最后一张比分杯垫压进账本，投影布卷好后，吧台重新留给生日菜单和薄荷甜点。",
    liveReaction: "",
    dialogues: ["直播桌收好啦。", "杯垫放进账本。", "今晚只做甜点。", "投影布别沾奶泡。", "比分聊到这里。"]
  },
  rabbit_4: {
    team: "法国",
    reactionMood: "有点遗憾但平静",
    latestResult: "法国获得世界杯第四名，西班牙夺冠",
    upcoming: "没有待观看的比赛",
    pending: "把法国蓝线缝进发带内侧，留下比赛记忆，不让输赢占满整天",
    reaction: "她把法国队小旗叠好，蓝线缝进发带内侧，谈到第四名时只轻轻耸了耸肩。",
    liveReaction: "",
    dialogues: ["第四名也收好。", "蓝线缝在里面。", "Félicitations, Espagne.", "今晚去看荷花。", "小旗先叠起来。"]
  },
  rabbit_5: {
    team: "荷兰",
    reactionMood: "安静释然",
    latestResult: "世界杯已经结束，西班牙夺冠",
    upcoming: "没有待观看的比赛",
    pending: "橙色边框已经画完，接下来把看球角改画成盛夏咖啡馆",
    reaction: "他补完橙色边框最后一角，又在旁边画了一扇卷起投影布的窗。",
    liveReaction: "",
    dialogues: ["橙色这一页完成了。", "投影布卷起来。", "下一页画荷花。", "比分不必再补。", "窗边留一点橙色。"]
  },
  rabbit_6: {
    team: "挪威",
    reactionMood: "遗憾后恢复稳重",
    latestResult: "挪威止步八强，西班牙夺得世界杯冠军",
    upcoming: "没有待观看的比赛",
    pending: "把战术纸改成露营物资清单，早餐不用再配凌晨开球时间",
    reaction: "他把战术纸翻到背面写帐篷钉和早餐份数，提到挪威时仍有点遗憾，但不再设清晨闹钟。",
    liveReaction: "",
    dialogues: ["战术纸翻面用。", "早餐按正常时间。", "帐篷钉再数一遍。", "挪威这页收好。", "不用五点起啦。"]
  },
  rabbit_7: {
    team: "日本",
    reactionMood: "温和地翻篇",
    latestResult: "世界杯已经结束，西班牙夺冠",
    upcoming: "没有待观看的比赛",
    pending: "整理最后一组看球照片，之后把夜间镜头留给观星和湖面",
    reaction: "他给最后一组比赛照片标好日期，没有删掉日本出局那张，随后把镜头转回湖面。",
    liveReaction: "",
    dialogues: ["最后一组标好日期。", "那张照片先留着。", "镜头回到湖面。", "今晚只拍星星。", "比赛相册合上啦。"]
  }
};

const WORLD_CUP_FINISHED = true;
...
const worldCupMatchesByShanghaiDate = {
  ...
  "2026-06-29": [
    { kickoff: "03:00", kickoffTick: 1080, home: "南非", away: "加拿大" }
  ],
  "2026-06-30": [
    { kickoff: "01:00", kickoffTick: 360, home: "巴西", away: "日本" },
    { kickoff: "04:30", kickoffTick: 1620, home: "德国", away: "巴拉圭" },
    { kickoff: "09:00", kickoffTick: 3240, home: "荷兰", away: "摩洛哥" }
  ],
  "2026-07-01": [
    { kickoff: "01:00", kickoffTick: 360, home: "科特迪瓦", away: "挪威" },
    { kickoff: "05:00", kickoffTick: 1800, home: "法国", away: "瑞典" },
    { kickoff: "09:00", kickoffTick: 3240, home: "墨西哥", away: "厄瓜多尔" }
  ],
  "2026-07-02": [
    { kickoff: "00:00", kickoffTick: 0, home: "英格兰", away: "刚果民主共和国" },
    { kickoff: "04:00", kickoffTick: 1440, home: "比利时", away: "塞内加尔" },
    { kickoff: "08:00", kickoffTick: 2880, home: "美国", away: "波黑" }
  ],
  "2026-07-03": [
    { kickoff: "03:00", kickoffTick: 1080, home: "西班牙", away: "奥地利" },
    { kickoff: "07:00", kickoffTick: 2520, home: "葡萄牙", away: "克罗地亚" },
    { kickoff: "11:00", kickoffTick: 3960, home: "瑞士", away: "阿尔及利亚" }
  ],
  "2026-07-04": [
    { kickoff: "02:00", kickoffTick: 720, home: "澳大利亚", away: "埃及" },
    { kickoff: "06:00", kickoffTick: 2160, home: "阿根廷", away: "佛得角" },
    { kickoff: "09:30", kickoffTick: 3420, home: "哥伦比亚", away: "加纳" }
  ],
  "2026-07-05": [
    { kickoff: "01:00", kickoffTick: 360, home: "加拿大", away: "摩洛哥" },
    { kickoff: "05:00", kickoffTick: 1800, home: "巴拉圭", away: "法国" }
  ],
  "2026-07-06": [
    { kickoff: "04:00", kickoffTick: 1440, home: "巴西", away: "挪威" },
    { kickoff: "08:00", kickoffTick: 2880, home: "墨西哥", away: "英格兰" }
  ],
  "2026-07-07": [
    { kickoff: "03:00", kickoffTick: 1080, home: "葡萄牙", away: "西班牙" },
    { kickoff: "08:00", kickoffTick: 2880, home: "美国", away: "比利时" }
  ],
  "2026-07-08": [
    { kickoff: "00:00", kickoffTick: 0, home: "阿根廷", away: "埃及" },
    { kickoff: "04:00", kickoffTick: 1440, home: "瑞士", away: "哥伦比亚" }
  ],
  "2026-07-10": [
    { kickoff: "04:00", kickoffTick: 1440, home: "摩洛哥", away: "法国" }
  ],
  "2026-07-11": [
    { kickoff: "03:00", kickoffTick: 1080, home: "西班牙", away: "比利时" }
  ],
  "2026-07-12": [
    { kickoff: "05:00", kickoffTick: 1800, home: "挪威", away: "英格兰" },
    { kickoff: "10:00", kickoffTick: 3600, home: "阿根廷", away: "瑞士" }
  ]
};
...
function matchResultDialogue(char, match) {
  const profile = worldCupProfiles[char];
  const score = profile?.latestResult?.match(/\d+比\d+/)?.[0];
  return score ? `${profile.team}${score}。` : `${profile?.team || match.away}这场${match.kickoff}开球。`;
}

function matchesForRunDate() {
  if (WORLD_CUP_FINISHED) return [];
...
const locationActivities = {
  tree_house: [
    ...
    { status: "对今日钟", detail: "{name}把树屋小钟和当天纸条对了一遍，确认今晚不再有凌晨比赛提醒。" },
    { status: "折薄毯角", detail: "{name}把薄毯角折出一个小记号，留给晚归兔兔确认回家的方向。" },
    { status: "收清晨闹钟", detail: "{name}把已经不用的小闹钟收进抽屉，指针还停在很早的位置。" },
    { status: "收晾绳衣物", detail: "{name}把树屋晾绳上晒干的小衣物收下来，发现有一双袜子没人认领。" },
    { status: "收台阶蝉蜕", detail: "{name}用一张硬纸托起树屋台阶边的完整蝉蜕，轻得像没写字的便签。" }
  ],
  carrot_square: [
    ...
    { status: "擦长椅", detail: "{name}擦掉长椅上的细沙，木缝里露出一截没写完的铅笔线。" },
    { status: "摆遮阳牌", detail: "{name}把遮阳牌挪到公告牌旁，影子刚好盖住最烫的一块石板。" },
    { status: "倒伞桶泥水", detail: "{name}把广场边雨伞桶底的浅泥水倒掉，又垫进一块不会粘底的小木片。" }
  ],
  mushroom_cafe: [
    ...
    { status: "收杯垫", detail: "{name}把散在桌边的杯垫摞好，发现最下面那张还留着半圈水印。" },
    { status: "收投影钟", detail: "{name}拔掉投影钟的线，把已经结束的比分栏擦净后卷进收纳袋。" },
    { status: "归档夜间小旗", detail: "{name}把各队小旗按颜色叠好，连同最后几张杯垫一起放进赛后纸箱。" },
    { status: "擦赛后屏幕", detail: "{name}把世界杯结束后闲下来的投影屏擦干净，角落还贴着一小段蓝色纸胶带。" },
    { status: "晾洗净杯垫", detail: "{name}把洗净的旧杯垫排在后窗晾干，最后一只边缘还挂着一滴水。" },
    { status: "改写旧赛程", detail: "{name}把旧赛程纸翻到背面，写下凉饮、晚甜点和露营外带的数量。" },
    { status: "写生日菜单", detail: "{name}在菜单边角试写生日口味，把糖霜名字压得很小。" },
  ...
  timothy_farm: [
    ...
    { status: "盖草帽沿", detail: "{name}把草帽沿压低一点，确认小萝卜没有被太阳晒蔫。" },
    { status: "换水桶阴影", detail: "{name}把农场水桶移到棚下，捞出一片被太阳晒卷边的荷叶。" },
    { status: "铺湿麻布", detail: "{name}把浸凉的麻布铺在萝卜筐上，边角滴下三颗很慢的水珠。" },
    { status: "收干草籽", detail: "{name}在草垛边捡起两粒晒干的提摩西草籽，夹进农具箱的纸袋里。" }
  ],
  gear_workshop: [
    ...
    { status: "晒小铜垫片", detail: "{name}把两枚进过水的小铜垫片排在窗台上，隔一会儿翻面看看水汽退了没有。" }
  ],
  acorn_library: [
    ...
    { status: "补书签线", detail: "{name}把快散开的书签线重新打结，结下面压着一个很淡的日期。" },
    { status: "查半页注脚", detail: "{name}在半页注脚里找到一串很轻的铅笔点，像有人困着眼写下的路线。" },
    { status: "擦薄荷冰水印", detail: "{name}把借书台旁化开的薄荷冰挪开，轻轻擦掉书签边的一圈水印。" },
    { status: "给旧书透气", detail: "{name}把几本旧书在窗边错开半寸，让晚夏的风从书页之间慢慢穿过去。" },
    { status: "看透亮蜻蜓翅", detail: "{name}隔着窗台看蜻蜓翅膀被晒得透亮，等它飞走才翻下一页。" }
  ],
  botanical_garden: [
    ...
    { status: "挑枯叶", detail: "{name}从花盆边挑出两片枯叶，泥土里露出一颗圆圆的小石子。" },
    { status: "遮小嫩芽", detail: "{name}给新冒头的小嫩芽撑起一片叶子伞，免得午后太阳太直。" },
    { status: "浇凉热石板", detail: "{name}用喷壶余水浇过花圃边的热石板，深色水痕很快缩小一圈。" },
    { status: "收午后遮光布", detail: "{name}等太阳偏过去才卷起遮光布，顺手抖掉上面两片干叶。" }
  ],
  rainbow_lake: [
    ...
    { status: "看盛夏荷花", detail: "{name}沿彩虹湖畔慢慢看开到盛期的荷花，花瓣上的露水还没有完全干。" },
    { status: "约大家赏荷", detail: "{name}在湖边给大家留下一张赏荷便签，约好傍晚一起看荷花倒影。" },
    { status: "晾湿手帕", detail: "{name}把沾了湖水的手帕搭在木栏上，等风把最后一点潮气带走。" },
    { status: "数荷叶水珠", detail: "{name}沿湖边数了几颗荷叶水珠，数到一半发现倒影里多了一条路牌线。" },
    { status: "绕开软泥", detail: "{name}绕开荷塘边一小块软泥，把脚印留在更干净的石板上。" },
    { status: "挪湖边遮阳伞", detail: "{name}把湖边遮阳伞往荷花倒影外挪了半步，给长椅留下一块完整阴影。" },
    { status: "捞落水路线纸", detail: "{name}用细树枝把落进浅水的路线纸挑起来，纸上的荷花只晕开一瓣。" },
    { status: "看雨珠蜻蜓", detail: "{name}站在木栏半步外看蜻蜓抖翅膀，雨珠掉了两颗，第三颗还挂着。" },
    { status: "数圆小莲蓬", detail: "{name}沿荷叶间数刚长圆的小莲蓬，只记位置，没有伸手去摘。" },
    { status: "看结实莲蓬", detail: "{name}看一只更结实的莲蓬被风吹得点头，在图上多圈了一个小点。" }
  ],
  carrot_maze: [
  ...
  rabbit_mountain: [
    ...
    { status: "踩盛夏溪水", detail: "{name}和同伴沿森林里的浅溪慢慢走，浓树荫盖住半条水面，溪水仍然凉。" },
    { status: "选露营空地", detail: "{name}在郁郁葱葱的森林边挑了一块平整空地，准备下次一起露营。" },
    { status: "整理露营绳", detail: "{name}把露营绳和小灯分开放好，约大家等暑气退下去再上山观星。" },
    { status: "捡溪边石", detail: "{name}捡起一颗被溪水磨圆的小石头，在掌心里转了两圈才收好。" },
    { status: "听溪水转弯", detail: "{name}蹲在浅溪转弯处听水声变低，把湿掉的纸角夹进背包里。" },
    { status: "试帐篷灯", detail: "{name}试了试露营小灯，确认亮度不会盖过晚上真正的星光。" },
    { status: "重系营地细绳", detail: "{name}把营地木桩上松掉的细绳重新系紧，顺便抖掉绳结里两根松针。" },
    { status: "晾溯溪鞋", detail: "{name}把溯溪鞋倒放在树根旁，等鞋底最后一点水慢慢滴完。" },
    { status: "找昨夜萤光", detail: "{name}在营地草丛边找到三点昨夜萤光留下的位置，用小树枝围出一圈记号。" },
    { status: "压好晚风薄毯", detail: "{name}把帐篷里的薄毯角压在餐盒下，免得傍晚风又把它掀开。" },
    { status: "收蓝白营绳", detail: "{name}从灯塔方向捡回一截蓝白营绳，重新绕在营地木桩上。" }
  ],
  weather_station: [
    ...
    { status: "记清晨凉意", detail: "{name}在晨间记录末尾添了一笔比昨天更凉，又把笔帽扣回原位。" }
  ],
  observatory: [
    ...
    { status: "约夜间观星", detail: "{name}把盛夏观星时间写在纸条上，约大家等暑气退下去再来天文台。" },
    { status: "校星图边", detail: "{name}把星图边缘压平，确认今晚只记星座和湖面反光。" },
    { status: "记迟到星", detail: "{name}把一颗迟到的星标在角落，旁边留下一小格给明晚复查。" }
  ],
  shell_bay: [
    ...
    { status: "量潮线", detail: "{name}用小木棍量了量潮线，比昨天往后退了半个爪印。" },
    { status: "晾泡软蒲草绳", detail: "{name}把潮线边漂来的蒲草绳展开晾在石头上，泡软的结反而更容易解开。" }
  ],
  lighthouse: [
    ...
    { status: "坐凉石阶", detail: "{name}在灯塔阴影里的凉石阶停了一会儿，等耳朵不再被太阳晒得发热。" },
    { status: "晾海风草帽", detail: "{name}把滴完水的草帽挂在灯塔栏杆上，让海风从帽檐下面穿过去。" }
  ],
  chanson_hall: [
    ...
    { status: "收谱架夹", detail: "{name}把落在地上的谱架夹捡起来，夹口还粘着一点金色纸屑。" },
    { status: "压平折扇印", detail: "{name}把后台折扇从节目单上拿开，用掌心慢慢压平那道横印。" },
    { status: "开侧门散热", detail: "{name}把音乐厅侧门推开一条缝，热气出去后，前三个音听起来清楚一点。" },
    { status: "收侧门晚风", detail: "{name}把被晚风吹歪的节目单压好，空气里留下一点干草味。" }
  ]
};
...
function generateCharacterDay(char, def, index) {
  ...
  if (earlyPlan && regularWakeTick > tick) {
    ...
    const earlyDialogue = earlyPlan.match
      ? matchResultDialogue(char, earlyPlan.match)
    ...
    const returnDetail = earlyPlan.match
      ? `${def.name}看完开球后的主要比赛时段，把“${worldCupProfiles[char].latestResult}”交给小泽咖啡馆后沿道路回树屋补觉。`
...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得8月9日在植物园、海湾、图书馆、音乐厅和彩虹湖之间采蜜、找新花、擦水印并留下赏荷便签。",
    "记得自己支持巴西；世界杯结束后把黄绿色小旗折成书签，晚上重新留给赏荷和找花。",
  ...
  rabbit_2: [
    ...
    "记得8月9日在图书馆、植物园、工坊、咖啡馆和音乐厅之间养薄荷、修慢钟，最后把咖啡章盖得很端正。",
    "记得自己支持美国；世界杯结束后把球队贴纸放进旧表盒，凌晨闹钟改回正常起床提醒。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_3: [
    ...
    "记得自己的生日进入2天倒数时，咖啡馆生日菜单、看球杯垫和情报等级会一起升一格。",
    "记得灯塔门铃声滚到海湾时，要把杯垫翻面那行小字收进情报站。",
    "记得胡萝卜广场的小萝卜箭头也能和杯垫小字接上，不只咖啡馆有情报。",
    "记得糖罐底下折过三次的小票值得收进账本，别让奶泡盖住。",
    "记得8月9日在图书馆、彩虹湖、咖啡馆、灯塔和广场之间改菜单、看倒影、试新点心并整理当天情报。",
    "记得自己支持比利时；世界杯结束后要卷好投影布、归档比分杯垫，让咖啡馆夜晚恢复甜点和闲聊。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_4: [
    ...
    "记得8月9日在咖啡馆、广场、兔耳山、音乐厅、天文台和植物园之间整理发带、遮光布与晚间光线。",
    "记得自己支持法国；法国最终获得第四名，蓝线被缝进发带内侧，比赛结束后不让输赢占满整天。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_5: [
    ...
    "记得8月9日在音乐厅、咖啡馆、迷宫、彩虹湖、图书馆和灯塔之间收杯垫、数莲蓬、找冬天灵感。",
    "记得自己支持荷兰；世界杯结束后补完橙色边框，下一页改画卷起投影布的盛夏咖啡馆。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_6: [
    ...
    "记得8月9日在广场、农场、工坊、灯塔、海湾、音乐厅和咖啡馆之间倒伞桶、打包甜点、晾蒲草绳并收杯垫。",
    "记得自己支持挪威；世界杯结束后把战术纸翻面写露营物资，早餐不必再配凌晨开球时间。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_7: [
    ...
    "记得8月9日在彩虹湖、音乐厅、咖啡馆、兔耳山、灯塔、植物园、天文台和气象站之间拍夜露、帐篷灯与发带街拍。",
    "记得自己支持日本；世界杯结束后整理好最后一组比赛照片，把夜间镜头重新留给观星和湖面。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ]
};
...
const relationships = limitRelationshipYaml(`relationships:
  rabbit_1:
    ...
    rabbit_5:
      ...
      - 8月9日小悠米留下赏荷便签和花样本，杰拉德把莲蓬、迷宫转角和灯塔门铃接成新的晚夏章节。
    rabbit_6:
      - 挪威2比1淘汰巴西后，小悠米先恭喜劳伦斯；劳伦斯把庆祝声收轻，也没有急着展开战术纸。
    rabbit_7:
      - Lino会把小悠米在海湾、灯塔和植物园发现的小线索拍下来。
      - 小悠米偶尔清晨出门时，Lino会补拍她错过的路牌和节目单。
      - Lino会用安静镜头帮小悠米确认自己不是迷路。
      - 巴西2比1淘汰日本后，小悠米会收着庆祝声，Lino也会真心恭喜她再把失落照片收好。
      - 8月9日Lino拍下彩虹湖夜露和植物园花样时，也替小悠米留住赏荷路线与图鉴颜色。
  rabbit_2:
    rabbit_6:
      - 乔治喊“给我劳”会让劳伦斯误以为在叫他。
      ...
      - 6月28日Lino拍下解释现场后，乔治知道要把话说完整，劳伦斯也愿意先听完再分栏。
      - 8月9日乔治修慢钟和浇薄荷时把手表梗说完整，劳伦斯也先听完再确认，不急着误会。
    rabbit_3:
      - 乔治给小泽咖啡馆友情提供植物园薄荷。
      - 小泽常把乔治吃瘪的表情做成咖啡奶泡。
      ...
      - 比利时4比1战胜美国后，乔治承认小泽支持的球队踢得更稳；小泽把比分写在杯垫背面，还给他留了薄荷甜点。
      - 世界杯结束后，小泽把比分杯垫收进账本；乔治把球队贴纸装进旧表盒，两人不再为凌晨闹钟拌嘴。
    rabbit_4:
      - 乔治喜欢晓雪，也只有晓雪能治住他。
      - 晓雪会用法语和浓缩咖啡让乔治慢慢解释。
      - 晓雪递咖啡时，乔治会短暂收起调皮劲。
  ...
  rabbit_3:
    rabbit_2:
      - 比利时4比1战胜美国后，小泽没有当面晃比分杯垫，只把咖啡机调小并给乔治留了一块薄荷甜点。
    rabbit_5:
      - 小泽咖啡馆的招牌是杰拉德画的。
    ...
    rabbit_7:
      ...
      - 比利时加时3比2逆转塞内加尔后，Lino会拍下小泽手还在抖却先把咖啡机声音调小的样子。
      - 7月8日小泽把灯塔小册和广场纸条排成情报线时，Lino会补拍杯垫背面的日期。
      - 8月9日小泽把旧赛程改成晚甜点菜单、试做新品，Lino拍下杯垫、夜露和吧台的安静灯光。
    rabbit_4:
      - 小泽推出新品时总邀请晓雪拍照推广。
      - 小泽会给晓雪预留新品照片位和温柔灯光。
      - 小泽整理植物牌方向时，晓雪会帮他把纸条和色卡分开放好。
      - 7月3日小泽一边邀请晓雪拍照一边假装没听见抓马，晓雪盖好咖啡章后才接下拍摄安排。
  rabbit_4:
    rabbit_7:
      - 晓雪经常请Lino拍发带穿搭街拍照。
      ...
      - 6月29日Lino替晓雪拍下薄荷色发带，晓雪先绑好植物牌才安心站到镜头前。
      - 8月9日晓雪收好遮光布、整理发带和晨星时，Lino也把她在山路与天文台的晚夏光线收进照片。
    rabbit_6:
      - 晓雪知道劳伦斯误会乔治时需要一点温柔解释。
      - 晓雪尊重劳伦斯照顾大家，也会提醒他别让误会变重。
      - 晓雪晾气象站纸条时，劳伦斯会安静等字迹清楚再判断路线。
      - 法国4比1战胜挪威后，晓雪会收着一点庆祝声，把咖啡推给失落但仍为晋级安心的劳伦斯。
      - 世界杯结束后，晓雪把法国蓝线缝进发带内侧；劳伦斯把战术纸翻面写露营清单，两人都关掉凌晨闹钟。
    rabbit_2:
      - 晓雪会用法语吐槽和浓缩咖啡治住乔治。
      - 乔治调皮时晓雪会先端稳咖啡，再让他解释。
      - 晓雪知道乔治点头不等于解释完，会把话题慢慢拉回来。
      - 6月28日晓雪递过浓缩咖啡后，乔治把路牌方向重新确认了一遍，没有把解释拖到睡前。
  rabbit_5:
    rabbit_1:
      - 杰拉德把小悠米带回的花当作绘画素材。
      - 杰拉德会把小悠米的探险线索画成奇幻章节。
    rabbit_6:
      ...
      - 荷兰点球出局、挪威晋级后，劳伦斯会把庆祝收轻一点，让杰拉德慢慢画完或留空那道橙色边框。
      - 8月9日杰拉德在咖啡馆画图、在湖边数莲蓬时，劳伦斯先把甜点和杯垫收稳，等他画完再问。
      - 世界杯结束后，劳伦斯把战术纸改成露营清单；杰拉德补完橙色边框，准备画恢复日常的咖啡馆。
    rabbit_3:
      - 杰拉德给小泽咖啡馆设计了招牌。
      - 杰拉德会从小泽咖啡馆听来的情报里找第二章灵感。
  rabbit_6:
    rabbit_1:
      - 挪威2比1战胜巴西后，劳伦斯先看小悠米有没有难过，再把早餐和庆祝声一起放轻。
    rabbit_2:
      - 劳伦斯时常误会乔治对自己有不一样的感情。
    ...
    rabbit_3:
      ...
      - 挪威比赛尚未结束时，小泽曾帮劳伦斯把战术纸和早餐订单分开放。
      - 世界杯结束后，小泽卷好直播投影布，劳伦斯也把凌晨看球早餐改回普通露营早餐。
  rabbit_7:
    rabbit_1:
    ...
    rabbit_4:
      ...
      - 盛夏赏荷和观星时，Lino会拍晓雪的法国队发带与湖面荷花倒影。
    rabbit_3:
      - Lino会在小泽咖啡馆安静整理吃瓜照片。
      - Lino会把小泽杯垫、公告牌和节目单拍成安静证据。
      - Lino拍到面包屑星座后，会把照片交给小泽整理成咖啡馆传闻。
      - 日本1比2被巴西终场前绝杀后，小泽会给Lino留一盏不刺眼的灯，让他自己决定何时整理最后那张照片。
    rabbit_2:
      - Lino拍到过乔治向劳伦斯解释“给我劳”的现场。
      - Lino常用镜头记录乔治解释、晓雪递咖啡和劳伦斯误会的瞬间。
      - 6月28日Lino把乔治的解释和溪水小石头拍在同一组照片里，让劳伦斯看到事情已经说清。
      - 8月9日Lino拍乔治解释现场时仍把快门声放轻，让劳伦斯先听清手表梗再判断。
      - 7月3日Lino再次拍到乔治及时补完手表解释，照片保留了劳伦斯从复杂表情慢慢听下去的过程。
`);
