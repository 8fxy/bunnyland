...
const worldCupProfiles = {
  rabbit_1: {
    ...
    dialogues: ["巴西停在这里啦。", "劳伦斯，恭喜。", "这朵花先不涂色。", "我还会继续看。"]
  },
  rabbit_2: {
    team: "美国",
    reactionMood: "嘴硬但低落",
  ...
  rabbit_7: {
    ...
    dialogues: ["最后一下太快了。", "一比二，记住了。", "照片先不删。", "小悠米，恭喜呀。"]
  }
};
...
const memoryNotes = {
  rabbit_1: [
    ...
    "记得7月4日在彩虹湖约大家赏荷，也在图书馆、灯塔和音乐厅之间反复核对那条虚线路线。",
    "记得自己支持巴西；1比2输给挪威止步16强后，先恭喜劳伦斯，再把黄绿色小旗夹进图鉴。",
  ...
  rabbit_2: [
    ...
    "记得7月4日照看薄荷、试过门铃备用齿轮，也在回家前把广场路牌重新确认了一遍。",
    "记得自己支持美国；1比4输给比利时止步16强，嘴硬归嘴硬，也承认小泽支持的球队踢得更稳。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_3: [
    ...
    "记得7月4日整理情报站、试开场曲，也把彩虹湖倒着走的小箭头压在杯垫下面。",
    "记得自己支持比利时；4比1战胜美国晋级8强后，把比分写在杯垫背面，还给乔治多留了一块薄荷甜点。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_4: [
    ...
    "记得7月4日读过雨量杯、约过夜间观星，也在兔耳山浅溪边把松开的结重新系好。",
    "记得自己支持法国；1比0战胜巴拉圭晋级8强后只补一针细蓝线，下一场要面对摩洛哥。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_5: [
    ...
    "记得7月4日把迷宫纹样、节目单和糖罐倒影接成第二章，还把劳伦斯的加餐盘悄悄推远半寸。",
    "记得自己支持荷兰；1比1后点球2比3输给摩洛哥止步32强，没画完的橙色边框可以先留着。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_6: [
    ...
    "记得7月4日听过海湾潮声、试过灯塔门铃，也在厚毛衣里把误会和事实重新分栏。",
    "记得自己支持挪威；2比1战胜巴西晋级8强后先收轻庆祝声，照顾小悠米的失落，下一场对英格兰。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_7: [
    ...
    "记得7月4日拍过彩虹湖荷花、晓雪发带和植物牌背面小字，也把兔耳山变深的树荫收进镜头。",
    "记得自己支持日本；1比2被巴西终场前绝杀后止步32强，失落也不必删掉那张照片。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ]
};
