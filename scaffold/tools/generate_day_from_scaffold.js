...
const worldCupProfiles = {
  ...
  rabbit_2: {
    team: "美国",
    reactionMood: runDate === "2026-06-26" ? "期待" : "得意",
  ...
  rabbit_5: {
    team: "荷兰",
    reactionMood: runDate === "2026-06-26" ? "专注" : "振奋",
  ...
  rabbit_7: {
    team: "日本",
    reactionMood: runDate === "2026-06-26" ? "专注" : "雀跃",
...
const memoryNotes = {
  ...
  rabbit_2: [
    ...
    "记得自己支持美国；6月26日10:00对土耳其要按真实开球时间看，比分等哨声后再写。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_3: [
  ...
  rabbit_5: [
    ...
    "记得自己支持荷兰；上海时间6月26日07:00对突尼斯要准时看，橙色画纸先留空。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ],
  rabbit_6: [
  ...
  rabbit_7: [
    ...
    "记得自己支持日本；上海时间6月26日07:00对瑞典要准时调曝光，照片等比赛画面出现再拍。",
    "记得这一天会活动到当天实际回家时间附近，再回树屋睡觉。"
  ]
};
...
const relationships = limitRelationshipYaml(`relationships:
  ...
  rabbit_2:
    ...
    rabbit_4:
      ...
      - 乔治支持美国，6月26日10:00看土耳其对美国前，晓雪会先让他把蓝帽子和比分纸分开放。
  rabbit_3:
    rabbit_5:
      - 小泽咖啡馆的招牌是杰拉德画的。
  ...
  rabbit_5:
    ...
    rabbit_6:
      ...
      - 荷兰6月26日07:00对突尼斯时，劳伦斯会把早餐和橙色画纸分开放，免得杰拉德一边看球一边被投喂。
    rabbit_3:
      - 杰拉德给小泽咖啡馆设计了招牌。
  ...
  rabbit_7:
    ...
    rabbit_3:
      ...
      - 日本6月26日07:00对瑞典时，小泽会给Lino留一盏不刺眼的投影灯，方便他准时调曝光。
    rabbit_2:
